...
# Try to find skill in project location first, then global
if [[ -d ".claude/skills/$SKILL_NAME" ]]; then
    ...
    echo "Error: Skill '$SKILL_NAME' not found in:" >&2
    echo "  - Project location: .claude/skills/$SKILL_NAME" >&2
    echo "  - Global location: $HOME/.claude/skills/$SKILL_NAME" >&2
    exit 1
fi
